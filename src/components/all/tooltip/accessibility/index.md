...
# Tooltip Accessibility Guidelines

## Overview

Ensuring the tooltip component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-tooltip" role="region" aria-labelledby="tooltip-title">
  <h2 id="tooltip-title">Accessible Tooltip</h2>
