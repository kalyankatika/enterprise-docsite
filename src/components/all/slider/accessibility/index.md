...
# Slider Accessibility Guidelines

## Overview

Ensuring the slider component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-slider" role="region" aria-labelledby="slider-title">
  <h2 id="slider-title">Accessible Slider</h2>
