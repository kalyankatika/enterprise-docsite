...
# Field Key Accessibility Guidelines

## Overview

Ensuring the field key component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-field-key" role="region" aria-labelledby="field-key-title">
  <h2 id="field-key-title">Accessible Field Key</h2>
