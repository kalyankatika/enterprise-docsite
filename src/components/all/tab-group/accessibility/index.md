...
# Tab Group Accessibility Guidelines

## Overview

Ensuring the tab group component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-tab-group" role="region" aria-labelledby="tab-group-title">
  <h2 id="tab-group-title">Accessible Tab Group</h2>
