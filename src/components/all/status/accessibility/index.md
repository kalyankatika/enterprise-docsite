...
# Status Accessibility Guidelines

## Overview

Ensuring the status component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-status" role="region" aria-labelledby="status-title">
  <h2 id="status-title">Accessible Status</h2>
