...
# Field Group Accessibility Guidelines

## Overview

Ensuring the field group component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-field-group" role="region" aria-labelledby="field-group-title">
  <h2 id="field-group-title">Accessible Field Group</h2>
