...
# Footnotes And Disclosures Accessibility Guidelines

## Overview

Ensuring the footnotes and disclosures component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-footnotes-and-disclosures" role="region" aria-labelledby="footnotes-and-disclosures-title">
  <h2 id="footnotes-and-disclosures-title">Accessible Footnotes And Disclosures</h2>
