...
# Grid Accessibility Guidelines

## Overview

Ensuring the grid component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-grid" role="region" aria-labelledby="grid-title">
  <h2 id="grid-title">Accessible Grid</h2>
