...
# Page Footer Accessibility Guidelines

## Overview

Ensuring the page footer component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-page-footer" role="region" aria-labelledby="page-footer-title">
  <h2 id="page-footer-title">Accessible Page Footer</h2>
