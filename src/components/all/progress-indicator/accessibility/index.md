...
# Progress Indicator Accessibility Guidelines

## Overview

Ensuring the progress indicator component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-progress-indicator" role="region" aria-labelledby="progress-indicator-title">
  <h2 id="progress-indicator-title">Accessible Progress Indicator</h2>
