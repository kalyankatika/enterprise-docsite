...
# Microcopy Accessibility Guidelines

## Overview

Ensuring the microcopy component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-microcopy" role="region" aria-labelledby="microcopy-title">
  <h2 id="microcopy-title">Accessible Microcopy</h2>
