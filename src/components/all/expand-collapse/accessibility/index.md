...
# Expand Collapse Accessibility Guidelines

## Overview

Ensuring the expand collapse component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-expand-collapse" role="region" aria-labelledby="expand-collapse-title">
  <h2 id="expand-collapse-title">Accessible Expand Collapse</h2>
