...
# File Upload Accessibility Guidelines

## Overview

Ensuring the file upload component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-file-upload" role="region" aria-labelledby="file-upload-title">
  <h2 id="file-upload-title">Accessible File Upload</h2>
