...
# Spinner Accessibility Guidelines

## Overview

Ensuring the spinner component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-spinner" role="region" aria-labelledby="spinner-title">
  <h2 id="spinner-title">Accessible Spinner</h2>
