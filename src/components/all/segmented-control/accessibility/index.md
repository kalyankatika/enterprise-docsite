...
# Segmented Control Accessibility Guidelines

## Overview

Ensuring the segmented control component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-segmented-control" role="region" aria-labelledby="segmented-control-title">
  <h2 id="segmented-control-title">Accessible Segmented Control</h2>
