...
# Tag Accessibility Guidelines

## Overview

Ensuring the tag component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-tag" role="region" aria-labelledby="tag-title">
  <h2 id="tag-title">Accessible Tag</h2>
