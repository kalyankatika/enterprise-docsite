...
# Textarea Accessibility Guidelines

## Overview

Ensuring the textarea component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-textarea" role="region" aria-labelledby="textarea-title">
  <h2 id="textarea-title">Accessible Textarea</h2>
