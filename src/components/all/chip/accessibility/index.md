...
# Chip Accessibility Guidelines

## Overview

Ensuring the chip component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-chip" role="region" aria-labelledby="chip-title">
  <h2 id="chip-title">Accessible Chip</h2>
