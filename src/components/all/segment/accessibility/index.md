...
# Segment Accessibility Guidelines

## Overview

Ensuring the segment component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-segment" role="region" aria-labelledby="segment-title">
  <h2 id="segment-title">Accessible Segment</h2>
