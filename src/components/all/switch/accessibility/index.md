...
# Switch Accessibility Guidelines

## Overview

Ensuring the switch component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-switch" role="region" aria-labelledby="switch-title">
  <h2 id="switch-title">Accessible Switch</h2>
