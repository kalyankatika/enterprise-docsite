...
Ensuring the image component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-image" role="region" aria-labelledby="image-title">
  <h2 id="image-title">Accessible Image</h2>
