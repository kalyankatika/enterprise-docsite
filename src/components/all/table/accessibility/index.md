...
Ensuring the table component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-table" role="region" aria-labelledby="table-title">
