...
# Text Input Accessibility Guidelines

## Overview

Ensuring the text input component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-text-input" role="region" aria-labelledby="text-input-title">
  <h2 id="text-input-title">Accessible Text Input</h2>
