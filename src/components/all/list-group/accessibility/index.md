...
# List Group Accessibility Guidelines

## Overview

Ensuring the list group component is accessible to all users, including those using assistive technologies.
...
```html
<div class="eds-list-group" role="region" aria-labelledby="list-group-title">
  <h2 id="list-group-title">Accessible List Group</h2>
