...
6. // Consolidated: // Add this code at the end of your app.js file, after the EdsdNavToc class is defined

// Extend EdsdNavToc to filter headings based on data-toc-ignored attribute
(function() {
  // Store the original getHeadings method
  const originalGetHeadings = EdsdNavToc.prototype.getHeadings;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateTOCVisibility() {
    ...
    document.querySelectorAll('edsd-nav-toc').forEach(toc => {
